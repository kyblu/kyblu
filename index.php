...
<body class="theme-red">
    ...
    <nav class="navbar">
        <div class="container-fluid">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="index.php">ARRAS BAG</a>
            </div>
    ...
    <?php
       ...
       $sql_u = $koneksi->query("select* from tb_pengguna where id='$user_l'");
        ...
        <aside id="leftsidebar" class="sidebar">
            ...
            <div class="user-info">
                ...
                <div class="info-container">
                    <div class="name" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" style="color:black"> <?php echo $data_u['nama'] ?></div>

                    <div class="email" style="color:black" ><?php echo $data_u['level'] ?></div>
